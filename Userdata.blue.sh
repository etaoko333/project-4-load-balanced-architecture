...
aws s3 cp s3://${bucket_name}/index.html /var/www/html/blue/
aws s3 cp s3://${bucket_name}/error.html /var/www/html/blue/
aws s3 cp s3://${bucket_name}/profile.png /var/www/html/blue/
